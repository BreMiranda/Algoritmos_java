...
public class Prova {
    ...
    // a pergunta enquanto o codigo digitado for vÃ¡lido, e depois informar o preÃ§o da compra e pedir o metodo de pagamento
    ...
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= pessoas; i++){ // estrutura FOR para rodar o codigo enquanto a variavel i <= pessoas
            ...
            do {
                System.out.println("Códigos dos produtos disponíveis:");
                System.out.println();
                ...
                if (codigo <= 5 && codigo >= 1) { // estrututa IF que verifica se o codigo digitado é valido e corresponde a um produto, se sim, executa, se não, pula fora
                    System.out.print("Quantas unidades o " +i+ "º cliente comprou? ");
                    quantidade = sc.nextInt();                    
                    // estrutura IF ELSE para examinar cada codigo digitado e dar o preÃ§o da commpra
                    ...
                    System.out.println("O código digitado não existe, por favor, digite novamente.");
        ...
        } // a estrutura for la do começo fecha aqui, e vai voltar la no começo, incrementar a variavel i (i++) e vai testar se i <= n,
        ...
        System.out.println("Compras pagas no crédito: "+qntCredito);
        System.out.println("Compras pagas no débito: "+qntDebito);
    }
}
